...
decision_boundary=0.2;  % Decision threshold

a_values1 = [0.55:0.05/5.7:0.73];    % Amplitude of stimulus inputs to column 1
a_values2 = [0.55:(-0.05)/5.7:0.37]; % Amplitude of stimulus inputs to column 2
